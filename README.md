...
__If you do use either of these traces in your research, please make sure to cite the following papers our paper --> "Fast Analysis and Prediction in Large Scale Virtual Machines Resource Utilisation__
